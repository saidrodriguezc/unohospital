<?PHP
  ...
  {
    $conceptomedid  = $_POST['conceptomedid'];
	$codigo         = strtoupper($_POST['codigo']);
	$descripcion    = strtoupper($_POST['descripcion']);	

	if($opcion == "guardarnuevo")
	{
        $vsql = "INSERT INTO conceptomed(codigo,descripcion,creador,momento) values('".$codigo."', 
	            '".$descripcion."','".$_SESSION['USERNAME']."',CURRENT_TIMESTAMP)";
    
		$cant = $clase->EjecutarSQL($vsql);
	
		if($cant == 1)
    		$clase->Aviso(1,"Concepto Medico creado Exitosamente");  	
		else
	...
	{
        $vsql = "UPDATE conceptomed SET codigo = '".$codigo."' , descripcion = '".$descripcion."' 
	             WHERE conceptomedid=".$conceptomedid;
    
	    $clase->EjecutarSQL($vsql);
	
   		$clase->Aviso(1,"Concepto Medico modificado Exitosamente");  			  
    }	
	
	header("Location: conceptomed.php");
  }
  ...
  if($opcion == "nuevo")
  {
	 ...
	 $cont.='<table width="100%">
	           <tr class="CabezoteTabla"> 
				 ...
				 <td width="520"> Nuevo Concepto Medico <td>
				 <td>  <a href="conceptomed.php"> Listado de Conceptos </a> </td>
    		     <td width="8"> </td>
			   </tr>	 			   
			 </table> ';	
  ...
  if($opcion == "detalles")
  {
	 ...
	 $cont.='<table width="100%">
	           <tr class="CabezoteTabla"> 
			     <td width="10"> </td>
			     <td width="37"> <img src="images/iconos/conceptomed.png" width="32" height="32" border="0"> </td>
				 <td width="510"> Conceptos Medicos <td>
				 <td>  <a href="conceptomed.php"> Listado de Conceptos </a> </td>
  	...
  	$vsql = "SELECT * FROM conceptomed WHERE conceptomedid=".$id;
	...
	if($row = mysql_fetch_array($result))
	{
		$cont.='<br><br><br><center>
	        ...
	        <input type="hidden" name="conceptomedid" value="'.$id.'">
			<table width="400">
	         <tr> 
			  <td> <label class="Texto15"> Codigo : </label> </td>
  ...
  {
    $id = $_GET['id'];
    $vsql = "DELETE FROM conceptomed WHERE conceptomedid=".$id;
	$clase->EjecutarSQL($vsql);
	$clase->Aviso(3,"Concepto Medico Eliminado Exitosamente");  		
	header("Location: conceptomed.php");
  }
  ...
  if($opcion == "encontrar")
  {
    ...
    $vsql = "SELECT * FROM conceptomed WHERE codigo like '%".$criterio."%' OR descripcion like '%".$criterio."%' ORDER BY codigo ASC Limit 0,".$_SESSION["NUMREGISTROSXCONSULTA"];
    $_SESSION['SQL_CONCEPTOMED'] = $vsql;
	header("Location: conceptomed.php");
  }
  ...
  {
    $criterio = $_POST['criterio'];
  	$vsql = "SELECT * FROM conceptomed ORDER BY codigo ASC limit 0,30";
  ...
  if($opcion == "")
  {
	 ...
	 $cont.='<table width="100%">
	           <tr class="CabezoteTabla"> 
			     <td width="10"> </td>
			     <td width="37"> <img src="images/iconos/conceptomed.png" width="32" height="32" border="0"> </td>
				 <td width="400"> Conceptos Medicos <td>
    ...
    $vsql = $_SESSION['SQL_CONCEPTOMED'];
	if($vsql == "")
    	$vsql = "SELECT * FROM conceptomed ORDER BY codigo ASC limit 0,".$_SESSION["NUMREGISTROSXCONSULTA"];
	...
	while($row = mysql_fetch_array($result)) 
	{
		 ...
		 $cont.=' <td> </td>
				  ...
				  <td> </td>
				  <td> <a href="?opcion=detalles&amp;id='.$row['conceptomedid'].'"> <img src="images/seleccion.png" border="0"> </td>				  
				  <td> </td>
				 </tr>';
	}
