<?PHP
  ...
  if($opcion == "ver")
  {
	...
	$nombreope = $clase->BDLockup($maquinariaid,"maquinaria","maquinariaid","descripcion");
	...
	$vsql="SELECT M.numorden , M.fecha , M.hora , T.nombre , AC.descripcion 
		   ...
		   INNER JOIN actrealizadas A ON (A.mantenimid = M.mantenimid)
		   INNER JOIN actividades AC ON (A.actividadid = AC.actividadid)
		   WHERE M.maquinariaid = ".$maquinariaid." ";
    ...
    $cont.= EncabezadoReporte("Mantenimientos Realizados por Maquina - ".$nombreope);	
	...
	$cont.='<div id="principal">
		    ...
		    <tr class="TablaDocsPar"> 
			 ...
			 <th width="100" align="left"> Realizo </th>			 			 
           </tr>';
