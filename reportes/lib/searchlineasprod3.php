  <?php 
    ...
    $getRecord_sql	=	'SELECT * FROM lineasprod WHERE codigo LIKE "'.$searchq.'%" Or descripcion LIKE "%'.$searchq.'%" limit 0,5';
	///////////////////////////////
	...
	while ($row = mysql_fetch_array($getRecord)) {?>
		...
		<li><a href="#" onClick="fill3('<?php echo $row['codigo']; ?>');return false;"> 
		<!-- Cambiar Aqui icono de la consulta -->
		<img src="images/iconos/lineasprod.png" border="0" width="22" height="22"> 
