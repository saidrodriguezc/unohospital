 ...
 class Sistema
 {
    ...
    function Conectar()
	{
	  ...
	  $this->ServidorBD = "localhost";
 	  if($this->NombreBD == "")
    	  $this->NombreBD   = $_SESSION['DBNOMBRE'];
...
<table class="Encabezado" align="center">
 <tr valign="top">
   ...
   <td class="MenuEncabezado">
	  ...
	  <a href="users.php?opcion=micuenta"> Menu del Usuario </a> | 
  ...
  <td width="200" bgcolor="#F6F6F6" valign="top"> 
	...
	<table border="0">
	  <tr>
	   ...
	   <td class="SubMenuP"> <a href="tactilapps.php"><img src="images/tactil.png" class="IconoSubMenu"> Apps T&aacute;ctiles </a> </td>	   
	  </tr><tr>
...
<table class="Encabezado" align="center">
 <tr valign="top">
   <td width="500"> </td>
   <td class="MenuEncabezado">
      <b>'.$_SESSION['NOMBREUSUARIO'].'</b> ( '.strtoupper($_SESSION['EMPRESAACTUAL']).' )<br>
	  <a href="usuarios.php?opcion=micuenta&id='.$_SESSION['USUARIO'].'"> Menu del Usuario </a> | 
	  <a href="usuarios.php?opcion=salir"> Salir del Sistema </a>  
   </td>      
 </tr>
</table>
...
return($cont);
   ...
   function NombreMes($mes)
   {
	...
	///////////////////////////////////////////////////////////////////////////
	function CrearComboFiltro($nombrecombo,$tabla,$caption,$valor,$urldestino,$nombrevariable,$pordefecto)
	{  
	   $vsql="SELECT ".$caption." caption ,".$valor." valor FROM ".$tabla." ORDER BY ".$caption."";
	   $conex = $this->Conectar();
       $result = mysql_query($vsql,$conex); 
