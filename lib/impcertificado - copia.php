<?PHP
  ...
  if($row = mysql_fetch_array($result)) 
  {
	 ...
	 $cont= 'CONCEPTO';                       	 $pdf->Text(46,54,$cont);		 
	 ...
	 // Datos Variables
	 $pdf->SetFont('Arial','B',12);    	 $pdf->Text(10,59,$row['tipoexamen']);	
	 $pdf->SetFont('Arial','',12);    	 $pdf->Text(47,59,substr($clase->BDLockup($row['conceptomed'],'conceptomed','codigo','descripcion'),0,100));		 
