  <?php 
    ...
    $getRecord_sql	=	'SELECT * FROM zonater WHERE codigo LIKE "'.$searchq.'%" Or descripcion LIKE "%'.$searchq.'%" limit 0,5';
	///////////////////////////////
	...
	while ($row = mysql_fetch_array($getRecord)) {?>
		...
		<li><a href="#" onClick="fill5('<?php echo $row['codigo']; ?>');return false;"> 
		<!-- Cambiar Aqui icono de la consulta -->
		<img src="images/iconos/zonater.png" border="0" width="22" height="22"> 
