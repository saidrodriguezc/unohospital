  <?php 
    ...
    $getRecord_sql	=	'SELECT * FROM clasificater WHERE codigo LIKE "'.$searchq.'%" Or descripcion LIKE "%'.$searchq.'%" limit 0,5';
	///////////////////////////////
	...
	while ($row = mysql_fetch_array($getRecord)) {?>
		...
		<li><a href="#" onClick="fill6('<?php echo $row['codigo']; ?>');return false;"> 
		<!-- Cambiar Aqui icono de la consulta -->
		<img src="images/iconos/gruposper.png" border="0" width="22" height="22"> 
