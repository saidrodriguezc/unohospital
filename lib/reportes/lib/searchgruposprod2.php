  <?php 
    ...
    $getRecord_sql	=	'SELECT * FROM gruposprod WHERE codigo LIKE "'.$searchq.'%" Or descripcion LIKE "%'.$searchq.'%" limit 0,5';
	///////////////////////////////
	...
	while ($row = mysql_fetch_array($getRecord)) {?>
  	    <!-- Cambiar Aqui Funcion FILL XX y campo a retornar de la consulta -->
		<li><a href="#" onClick="fill2('<?php echo $row['codigo']; ?>');return false;"> 
		<!-- Cambiar Aqui icono de la consulta -->
		<img src="images/iconos/gruposprod.png" border="0" width="22" height="22"> 
